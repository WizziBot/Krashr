module.exports = {
    ...
    execute(message,commandArgs,bot,krashr){
        try{
            const server = commandArgs;
            if (server === 'minesuperior'){
                console.log('CONNECTING')
                message.guild.channels.cache.find(ch => ch.name === krashr.commandChannel).send('CONNECTING')
                ...
                setTimeout(()=>{
                    ...
                    setTimeout(()=>{
                        ...
                        setTimeout(()=>{
                            ...
                            message.guild.channels.cache.find(ch => ch.name === krashr.commandChannel).send('CONNECTED')
                        },2000)
                    },2000)
                },2000)
